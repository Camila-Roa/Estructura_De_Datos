    ...
    class Ejercicio_1
    {
        ...
        public void Ingresar(){
            ...
            for (int f =0; f < 4; f++){
                ...
                for (int c= 0; c < 5; c++){
                 Console.WriteLine("Por favor ingrese un numero para la posicion "+ (f + 1) + ","+ (c + 1)+ ": ");
        ...
        public void Sumar_Columnas(){
         ...
         int columnas2 = 0;
         int suma1 = 0;
         Console.WriteLine("Por favor escriba el numero de columnas para sacar la suma correspondiente de cada una: ");
         columnas = Convert.ToInt32(Console.ReadLine());

         if(columnas < 4 ){
             for(int co = 0; co < columnas; co++){
               Console.WriteLine("Por favor escriba el numero de la columns de la cual desea hacer la suma:");
